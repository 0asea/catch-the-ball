...
score_pen1.write(f"AI Score {p1_score}", False, align="left", font=("Arial", 14, "normal"))

score_pen2 = turtle.Turtle()
score_pen2.penup()
score_pen2.setposition(265, 275)
score_pen2.pendown()
score_pen2.color("green")
score_pen2.hideturtle()
score_pen2.write(f"Score {p2_score}", False, align="left", font=("Arial", 14, "normal"))
